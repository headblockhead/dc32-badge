...
void make_layer_0(void) {
  ...
  key_add_KC(keys[0][2], 0, HID_KEY_2);
  key_add_KC(keys[0][3], 0, HID_KEY_3);
  key_add_KC(keys[0][4], 0, HID_KEY_4);
  key_add_KC(keys[0][5], 0, HID_KEY_5);
  key_add_KC(keys[0][6], 0, HID_KEY_6);
  key_add_KC(keys[0][7], 0, HID_KEY_7);
  key_add_KC(keys[0][8], 0, HID_KEY_8);
  key_add_KC(keys[0][9], 0, HID_KEY_9);
  ...
  // Row 2
  key_add_KC(keys[1][0], 0, HID_KEY_TAB);
  key_add_KC(keys[1][1], 0, HID_KEY_Q);
  key_add_KC(keys[1][2], 0, HID_KEY_D);
  key_add_KC(keys[1][3], 0, HID_KEY_R);
  key_add_KC(keys[1][4], 0, HID_KEY_W);
  key_add_KC(keys[1][5], 0, HID_KEY_B);
  key_add_KC(keys[1][6], 0, HID_KEY_J);
  key_add_KC(keys[1][7], 0, HID_KEY_F);
  key_add_KC(keys[1][8], 0, HID_KEY_U);
  key_add_KC(keys[1][9], 0, HID_KEY_P);
  key_add_KC(keys[1][10], 0, HID_KEY_SEMICOLON);
  key_add_KC(keys[1][11], 0, HID_KEY_BRACKET_LEFT);
  key_add_KC(keys[1][12], 0, HID_KEY_BRACKET_RIGHT);
  key_add_KC(keys[1][13], 0, HID_KEY_BACKSLASH);
  key_add_KC(keys[1][14], 0, HID_KEY_GRAVE);

  // Row 3
  key_add_KC(keys[2][0], 0, HID_KEY_BACKSPACE);
  key_add_KC(keys[2][1], 0, HID_KEY_A);
  key_add_KC(keys[2][2], 0, HID_KEY_S);
  key_add_KC(keys[2][3], 0, HID_KEY_H);
  key_add_KC(keys[2][4], 0, HID_KEY_T);
  key_add_KC(keys[2][5], 0, HID_KEY_G);
  key_add_KC(keys[2][6], 0, HID_KEY_Y);
  key_add_KC(keys[2][7], 0, HID_KEY_N);
  key_add_KC(keys[2][8], 0, HID_KEY_E);
  key_add_KC(keys[2][9], 0, HID_KEY_O);
  key_add_KC(keys[2][10], 0, HID_KEY_I);
  key_add_KC(keys[2][11], 0, HID_KEY_APOSTROPHE);
  key_add_KC(keys[2][12], 0, HID_KEY_ENTER);
  key_add_KC(keys[2][13], 0, HID_KEY_DELETE);
  key_add_KC(keys[2][14], 0, HID_KEY_PRINT_SCREEN);

  // Row 4
  key_add_mod(keys[3][0], 0, KEYBOARD_MODIFIER_LEFTSHIFT);
  key_add_KC(keys[3][1], 0, HID_KEY_Z);
  key_add_KC(keys[3][2], 0, HID_KEY_X);
  key_add_KC(keys[3][3], 0, HID_KEY_M);
  key_add_KC(keys[3][4], 0, HID_KEY_C);
  key_add_KC(keys[3][5], 0, HID_KEY_V);
  key_add_KC(keys[3][6], 0, HID_KEY_K);
  key_add_KC(keys[3][7], 0, HID_KEY_L);
  ...
  key_add_KC(keys[4][10], 0, HID_KEY_HOME);
  key_add_KC(keys[4][11], 0, HID_KEY_END);
